...
public class UserTestData {
    ...
    public static void init() {
        ADMIN = new User("Admin", "admin@javaops.ru", UserFlag.superuser,"msk");
        DELETED = new User("Deleted", "deleted@yandex.ru", UserFlag.deleted, "msk");
        FULL_NAME = new User("Full Name", "gmail@gmail.com", UserFlag.active, "msk");
        USER1 = new User("User1", "user1@gmail.com", UserFlag.active, "msk");
        USER2 = new User("User2", "user2@yandex.ru", UserFlag.active, "msk");
